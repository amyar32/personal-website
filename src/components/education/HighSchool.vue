<template>
  <div class="flex flex-col w-full h-full md:flex-row">
    <!-- gambar uin  -->
    <div
      class="bg-background-3 bg-center bg-cover w-full h-3/6 rounded-t-3xl md:h-full md:w-6/12 md:rounded-l-3xl md:shadow-padat-md"
    ></div>
    ...
    >
      ...
      <p class="text-sm mb-3">
        in
        <span class="font-bold italic">2013 - 2016</span>
      </p>
      ...
      <a
        ...
        href="https://mapersispadalarang.sch.id"
        target="_blank"
        >Learn More</a
      >
    </div>
